...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	 ...
	 */
	public $siteTitle                = 'arnando.my.id';       // Site Title, example.com
	public $adminEmail               = 'arnando@arnando.my.id'; // Admin Email, admin@example.com
	...
	public $emailConfig = [
		'mailType' => 'html',
		'protocol' => 'smtp',
		'smtp_host' => 'mail.arnando.my.id',
		'smtp_port' => 587,
		'smtp_user' => 'admin@arnando.my.id',
		'smtp_pass' => 'gitbanyak123',
	];
